                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-4">
                            ...
                            <a href="?dell=all" class="btn btn-danger rounded-pill shadow-none btn-sm">
                        ...
                        <div class="table-responsive-md" style="height:450px; overflow-y:scroll;">
                            <table class=" table table-hover border">
                                ...
                                <tbody>
                                    <?php
                                    //affiche le contenu de la base de donne de (**contacte**)) 
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        ...
                                        $seen .= "<a href='?dell=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger mt-2 '>Delete</a>";
                                        echo <<<query
                                             <tr>
                                                 <td>$i</td>
                                                 <td>$row[name]</td>
