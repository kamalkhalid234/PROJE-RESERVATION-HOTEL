            ...
            <div class="col-lg-4 col-md-6 my-3">
              <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                ...
                <div class="card-body">
                  ...
                  <h6 class="mb-4">DH $room_data[price] per night</h6>
                            ...
                            <span class="badge rounded-pill bg-light text-dark text-wrap ">
                               ...
                               <div class="rating mb-4">
                                        ...
                                        <div class="d-flex justify-content-evenly mb-2">
                                            ...
                                            <a href="room_details.php?id=$room_data[id]" class="btn btn-sm btn-outline-dark shadow-non ">More
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                echo <<<data
                         <div class="col-lg- col-md-2 text-center bg-white rounded shadow py-4 my-3">
                           <img width="50" src="$path/$row[icon]" alt="">
                           <h5 class="mt-3">$row[name]</h5>
                         </div>
                ...
                <div class="swiper swiper-testimonials">
                    <div class="swiper-wrapper mb-5">
                        ...
                        <div class="swiper-slide bg-white  p-4 ">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit minus, vitae
                                obcaecati
                    ...
                    <form id="recovery-form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-2 text-end">
                                <button type="button" class="btn shadow-none me-2"
