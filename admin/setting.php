                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal"
                                data-bs-target="#contacts-s"><i class="bi bi-pencil-square"></i>
                                Edit
                            </button>
                        </div>
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="text" name="gmap" class="form-control shadow-none"
                                                        id="gmap_inp" required>
                                                </div>
                                                <div class=" mb-3">
                                                    <label class="form-label fw-bold ">Phone Numbers (with
                                                        country code )</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class=" mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><i
                                                                class="bi bi-instagram mb-1"></i></span>
                                                        <input type="text" name="insta" id="insta_inp"
                                                            class="form-control shadow-none" required>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><i
                                                                class="bi bi-twitter mb-1"></i></span>
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="text" name="iframe" class="form-control shadow-none"
